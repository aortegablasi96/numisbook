...
export const en = {
  ...
  // CSV import (ADR-017 addendum). The panel's copy; the CSV's own column
  // headers stay English in every locale — they are a data contract, not prose.
  "import.action": "Import CSV",
  "import.title": "Import CSV",
  "import.intro": "Add coins to {collection} from a CSV file with the same columns as an export.",
  "import.fileAria": "CSV file to import",
  "import.chooseFile": "Choose a file",
  "import.reading": "Reading…",
  "import.rowsRead": "{n} rows read",
  "import.willAdd": "{n} coins will be added to {collection}",
  "import.added": "{n} coins added to {collection}",
  "import.skipped": "{n} rows cannot be imported and will be skipped",
  "import.colRow": "Row",
  "import.colColumn": "Column",
  "import.colReason": "Reason",
  "import.andMore": "…and {n} more",
  "import.commit": "Add {n} coins",
  ...
  "coins.filterAll": "All",
  "coins.facetSearchPlaceholder": "Filter…",
  "coins.facetSearchAria": "Filter {field}",
  "coins.facetNoMatches": "No matches",
  ...
  "coins.sortOldest": "Oldest first",
  "coins.sortAz": "{field} (A–Z)",
  "coins.sortZa": "{field} (Z–A)",
  "coins.sortOldFirst": "{field} (oldest first)",
  "coins.sortNewFirst": "{field} (newest first)",
  "coins.add": "+ Add coin",
