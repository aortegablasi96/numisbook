// Shared inline SVG icons (lucide-style, stroked with currentColor) for action
// controls. Kept dependency-free per the design-system rule (no lucide-react).
// `size` defaults to 14px to sit neatly inside `.btn-sm` action buttons.
...
/** The mirror of IconDownload: same tray, arrow pointing in. */
